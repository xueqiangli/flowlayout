...
class MainActivity : AppCompatActivity() {
    ...
    //标签名称
    private val mTvNames = arrayOf( "钉宫理惠", "灼眼的夏娜"
        ...
        , "绯弹的亚里亚", "零之使魔", "夕阳染红的街道","流式布局测试一下下，一行可以能放一个牙","短行1","短行2","短行3","短行4",
        "超过屏幕的一行行高，你觉着怎么布局呢，说说你的想法","动漫", "钉宫理惠", "灼眼的夏娜"
        , "绯弹的亚里亚", "零之使魔", "夕阳染红的街道","流式布局测试一下下，一行可以能放一个牙","短行1","短行2","短行3","短行4","超过屏幕的一行行高，你觉着怎么布局呢，说说你的想法","动漫", "钉宫理惠", "灼眼的夏娜"
        , "绯弹的亚里亚", "零之使魔", "夕阳染红的街道","流式布局测试一下下，一行可以能放一个牙","短行1","短行2","短行3","短行4","超过屏幕的一行行高，你觉着怎么布局呢，说说你的想法","动漫")
